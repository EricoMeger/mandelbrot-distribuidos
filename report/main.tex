%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Template revisado para SBC com ajustes de LaTeX
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{url}
\usepackage{hyperref}
\usepackage{hyperref} % Remova a linha se ela já existir
\hypersetup{
    colorlinks=true,
    linkcolor=black,  % Cor dos links internos (seções, figuras)
    citecolor=black,  % Cor das citações (ex: [Sobral 2018])
    urlcolor=black    % Cor dos URLs (ex: o link do GitHub)
}
...
\begin{center}
    \textbf{Tabela 1. Tempos de execução para 850.000 iterações.} \\ % Adicionamos o título manualmente
    \begin{tabular}{lcc}
        \toprule
...
\begin{enumerate}
    ...
    % (Nota: Usei 10min26s, que é mais preciso para 626.472 ms)
    \vspace{0.5em} % Adiciona um pequeno espaço extra
    \begin{itemize}
